	...
	{/*fadeIn()*/}
			...
			<div className="max-w-3xl">
				...
				<div className="flex flex-col lg:flex-row lg:flex-wrap">
					...
					<RecommendedPeople
						recPeopleTitle="David 'Ed' Edwards"
						recPeopleURL="https://www.dgedwards.com/"
						recPeopleDisplayURL="dgedwards.com"
						recPeopleClasses = {"order-" +  + Math.floor(Math.random() * 10)}
						recPeopleJob="Designer, Developer, Writer, Musician"
						recPeopleDescription="A man with an impressive array of skillsets, we met at University and I have had a huge amount of respect with what he does both professionally and personally. He also has an interesting 'edge'.">
					</RecommendedPeople>

      ...
      <div className={`navigation-wrapper bg-brown-dark navigation-wrapper--${menuActive} fixed transition-fast transform-x--100 top-0 left-0 p-6 w-full h-screen text-lg md:relative md:h-auto md:top-auto md:transform-x-0 md:p-3 md:w-auto md:bg-transparent`} >
        <ul className="">
          <li><AnimatedLink className="text-brown-feint block md:text-right" activeClassName="active" to="/">Home</AnimatedLink></li>
            <li><AnimatedLink className="text-brown-feint block md:text-right" to="/developer">Developer</AnimatedLink></li>
            <li><AnimatedLink className="text-brown-feint block md:text-right" to="/">Designer</AnimatedLink></li>
            <li><AnimatedLink className="text-brown-feint block md:text-right" to="/">Artist</AnimatedLink></li>
            <li><AnimatedLink className="text-brown-feint block md:text-right" to="/">Manager</AnimatedLink></li>
            <li><AnimatedLink className="text-brown-feint block md:text-right" to="/">Musician</AnimatedLink></li>
            <li><AnimatedLink className="text-brown-feint block md:text-right" to="/">Other</AnimatedLink></li>
            <li><AnimatedLink className="text-brown-feint block md:text-right" to="/">Contact</AnimatedLink></li>
        </ul>
      </div>

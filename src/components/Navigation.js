...
const Navigation = class extends React.Component {
  ...
  render() {
    ...
    return (     
    <nav className="">
      <div className={`navigation-wrapper bg-brown-dark navigation-wrapper--${menuActive} fixed transition-fast transform-x--100 top-0 left-0 p-6 w-full h-screen z-40 text-lg md:relative md:h-auto md:top-auto md:transform-x-0 md:p-3 md:w-auto md:bg-transparent`} >
        <ul className="">
